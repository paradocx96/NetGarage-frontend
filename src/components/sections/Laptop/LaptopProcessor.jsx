...
class LaptopProcessor extends Component {
    ...
    handleDelete = async (id) => {
        await ServiceLaptopProcessor.deleteLaptopProcessorById(id)
            .then(response => response.data)
            .then((data) => {
                console.log(data)
            }).catch(error => {
    ...
    submitDelete = (id) => {
        confirmAlert({
            ...
            message: 'Are you sure to delete this Processor?',
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => {
    ...
    checkAvailability = async () => {
        await ServiceLaptopProcessor.checkAvailable(this.state.name)
            .then(response => response.data)
            .then((data) => {
                console.log(data);
                if (data == true) {
